...
if(isset($_POST["submit"])){
    ...
    if($_POST["estatus"]==1){
        ...
        $query = "INSERT INTO factura SET fecha_factura='$fecha_factura', fecha_pago='$fecha_pago', monto='$monto', estatus='$estatus', id_proveedor='$id_proveedor'";
        mysqli_query($conn, $query);
        echo"<script> alert('Factura Agregada Correctamente'); window.location.replace('facturas.php'); </script>";
}
        ...
        <div class="section" style="background-color: #e6e6ff;">
            <div class="columns">
                ...
                <div class="row">
                    ...
                    <input type="date" class="form-control" name="factura" placeholder="Fecha de la Factura" required>
                    </div>
                    <div class="col">
                ...
                <div class="row" style="margin-top: 20px">
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="100000.00" step="0.01" class="form-control" name="monto" placeholder="Monto" required>
                        </div>    
                    <div class="col">
                ...
                <div class="row" style="margin-top: 20px">
                    <div class="col">
                        ...
                        <input type="date" class="form-control" name="pago" placeholder="Fecha de Pago" required>
                    </div>
                    <div class="col">
                    </div>
                </div>
