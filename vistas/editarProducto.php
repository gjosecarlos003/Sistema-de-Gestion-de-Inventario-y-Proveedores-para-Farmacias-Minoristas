...
if(isset($_POST["submit"])){
    ...
    $id_proveedor= $filaselec['id_proveedor'];
        ...
        $query = "UPDATE producto SET codigo_barra='$codigo_barra', nombre_comercial='$nombre_comercial', contenido='$contenido', nombre_generico='$nombre_generico', descripcion='$descripcion', laboratorio='$laboratorio', cantidad='$cantidad', precio='$precio', itbms='$itbms', id_proveedor='$id_proveedor'";
        mysqli_query($conn, $query);
        echo"<script> alert('Producto Actualizado Correctamente'); window.location.replace('productos.php'); </script>";
}
        ...
        <div class="section" style="background-color: #e6e6ff;">
            <div class="columns">
                ...
                <div class="row">
                    ...
                    <input type="text" class="form-control" name="comercial" value="<?php echo $row['nombre_comercial']?>" required>
                    </div>
                </div>
                <div class="row" style="margin-top: 20px">
                    <div class="col">
                    <label for="contenido">Contenido</label>
                    <input type="text" class="form-control" name="contenido" value="<?php echo $row['contenido']?>" required>
                    </div>
                    <div class="col">
                    <label for="generico">Nombre Genérico</label>
                    <input type="text" class="form-control" name="generico" value="<?php echo $row['nombre_generico']?>" required>
                    </div>
                </div>
                <div class="row" style="margin-top: 20px">
                    <div class="col">
                    ...
                    <input type="text" class="form-control" name="laboratorio" value="<?php echo $row['laboratorio']?>" required>
                    </div>
                </div>
                <div class="row" style="margin-top: 20px">
                    <div class="col">
                    ...
                    <div class="col">
                        ...
                        <input type="number" min="0.00" max="100000.00" step="0.01" class="form-control" name="precio" value="<?php echo $row['precio']?>" required>
                        </div>
                </div>
                <div class="row" style="margin-top: 20px">
                    <div class="col">
